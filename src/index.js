...
const realNodes = [
  ...
  // 🇩🇪 LTE #1 (объединён с Мобильной связью #1)
  { tag: "lte-1", address: "de-new.datanode-internal.net", port: 443, id: "9d5e7e04-53e4-4d98-bb26-236c907078a5", serverName: "ads.x5.ru", publicKey: "r6lN34m1nN-xQZ458j5NPD5xJ3_QBF2bGzY4KJEo4ic", shortId: "abbcd128", fingerprint: "qq", remarks: "🇩🇪 LTE / Мобильная", flag: "de", network: "tcp", flow: "xtls-rprx-vision" }
];
    // ---- ПУСТОЙ СЕРВЕР ----
    const emptyNodes = [{
      tag: "disabled",
